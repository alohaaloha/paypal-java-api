(function () {
    ...
    multiselect.directive('multiselect', ['$filter', '$document', '$log', '$translate', function ($filter, $document, $log, $translate) {
        return {
            restrict: 'AE',
            scope: {
                options: '=',
            ...
            link: function ($scope, $element, $attrs, $ngModelCtrl) {
                ...
                $scope.getButtonText = function () {
                    ...
                    if ($scope.selectedOptions && $scope.selectedOptions.length > 1) {
                        ...
                        if (totalSelected === 0) {
                            return $scope.labels && $scope.labels.select ? $scope.labels.select : $translate.instant("buttonTextSingular");
                        } else {
                            return totalSelected + ' ' + ($scope.labels && $scope.labels.itemsSelected ? $scope.labels.itemsSelected : $translate.instant("buttonTextPlural"));
                        }
                    } else {
                        return $scope.labels && $scope.labels.select ? $scope.labels.select : $translate.instant("buttonTextSingular");
                    }
